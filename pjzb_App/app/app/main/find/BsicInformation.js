     ...
     return (
         <View style={styles.bodyView}>
            <ScrollView style={styles.scrollView}>
                ...
                <View style={styles.textView}>
                    <Text style={[styles.text,{color:'#999'}]}>从业机构及其各分支机构经营场所</Text>
                    <Text style={styles.text}>无</Text>
                </View>
                <View style={styles.textView}>
                    <Text style={[styles.text,{color:'#999'}]}>注册协议模板</Text>
                    <Text style={[styles.text,{color:'#319bff'}]} onPress={() => this.opAgreement()}>《普金资本服务协议》</Text>
                </View>
                <View style={styles.textView}>
                    <Text style={[styles.text,{color:'#999'}]}>资金存管情况</Text>
                    <Text style={styles.text}>与江西银行协议洽谈中</Text>
                </View>
                <View style={styles.textView}>
                    <Text style={[styles.text,{color:'#999'}]}>合作第三方机构的关联系</Text>
                    <Text style={styles.text}>无</Text>
                </View>
                <View style={[styles.textView,{marginBottom:30/oPx}]}>
                    <Text style={[styles.text,{color:'#999'}]}>与保险机构、担保机构等各类涉及个体网络借贷业务相关的第三方机构合作情况</Text>
                    <Text style={styles.text}>无</Text>
                </View>
            </ScrollView>
         </View>
