      ...
      return (
        <View style={styles.container}>
            ...
            <View style={styles.rowTr}>
                ...
                <View style={styles.rightView}><Text style={styles.rightText}>已认证</Text></View>
            </View>
            <View style={styles.rowTr}>
                <View style={styles.leftView}><Text style={styles.leftText}>ICP备案号</Text></View>
                <View style={styles.rightView}><Text style={styles.rightText}>赣ICP备16004010号</Text></View>
            </View>
            <View style={styles.rowTr}>
                <View style={[styles.leftView,{borderBottomWidth:StyleConfig.borderWidth}]}><Text style={styles.leftText}>地方金融监管部门备案登记信息</Text></View>
                <View style={[styles.rightView,{borderBottomWidth:StyleConfig.borderWidth}]}><Text style={styles.rightText}>无</Text></View>
            </View>
        </View>
      );
    }
